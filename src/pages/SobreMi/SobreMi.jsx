    ...
    return (
        <section className="sobre-mi">
            ...
            <p className="sobre-mi-text">
                ...
                quiénes la utilizan y cómo puede mejorar procesos y experiencias dentro de una organización. Mi objetivo es seguir
                desarrollándome técnicamente mientras construyo un perfil interdisciplinario que conecte tecnología, personas y organizaciones.
            </p>
        </section>
    );
}
